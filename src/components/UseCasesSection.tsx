...
export function UseCasesSection() {
  ...
  return (
    <section id="sec-009" ref={ref} className="bg-solar-dark px-6 py-24 relative overflow-hidden">
      ...
      <div className="max-w-[88rem] mx-auto relative">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start mb-16">
          <div className="md:pr-8">
            ...
            <h2
              className={`text-5xl md:text-6xl lg:text-7xl font-medium leading-[0.95] mb-6 tracking-tight text-white ${inView ? "animate-fade-in-up" : "opacity-0"}`}
            ...
            <p
              className={`text-white/70 text-base md:text-lg leading-relaxed max-w-md ${inView ? "animate-fade-in-up" : "opacity-0"}`}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {USE_CASES.map((item, i) => (
            ...
            >
              <div className={`absolute inset-0 ${item.radius} transition-all duration-700 ${item.radiusHover} border-2 border-white/20 group-hover:border-solar-yellow/40`} />
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-solar-yellow/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              <div className="absolute inset-0 bg-gradient-to-t from-solar-dark/95 via-solar-dark/40 to-solar-dark/10" />
              ...
              <div className="relative z-10 flex flex-col justify-between h-full p-8 md:p-10">
                ...
                <div>
                  ...
                  <a href="#" className="inline-flex items-center gap-2 group/btn">
                    <span className="text-white font-medium text-base group-hover/btn:text-solar-yellow transition-colors duration-300">
                      Conocer más
                    </span>
