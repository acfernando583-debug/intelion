  ...
  return (
    <section ref={ref} className="bg-solar-gray px-6 py-24 relative overflow-hidden">
      <div className="absolute inset-0 opacity-30 pointer-events-none"
        style={{
          backgroundImage: "radial-gradient(circle at 10% 90%, rgba(255,214,0,0.15) 0%, transparent 40%), radial-gradient(circle at 90% 10%, rgba(76,175,80,0.1) 0%, transparent 40%)",
        }}
      />
      <div className="absolute inset-0 flex items-center justify-center opacity-20 pointer-events-none">
        <GeometricPattern type="hex-grid" color="rgba(0,51,102,0.4)" size={100} />
      </div>
          ...
          {[
            {
              ...
              color: "from-solar-dark to-solar-green"
            },
            {
              title: "Edificio",
              ...
              color: "from-solar-green to-solar-dark"
            },
            {
              title: "Industria",
            ...
            >
              ...
              <div className="absolute inset-0 opacity-20"
                style={{
                  backgroundImage: `radial-gradient(circle at ${30 + i * 20}% ${70 - i * 20}%, rgba(255,214,0,0.3) 0%, transparent 50%)`,
                }}
              />
              <div className="relative z-10 flex flex-col justify-between h-full p-8 md:p-10 min-h-[400px]">
                ...
                <div>
                  ...
                  <a href="#" className="inline-flex items-center gap-2 group">
                    <span className="w-10 h-10 rounded-full bg-solar-yellow/80 backdrop-blur flex items-center justify-center group-hover:bg-solar-yellow transition-all duration-300 group-hover:scale-110 group-hover:rotate-45">
                      <ArrowRight className="w-5 h-5 text-solar-dark" />
                    </span>
                    <span className="text-white font-medium text-base group-hover:text-solar-yellow transition-colors duration-300">
                      Conocer más
                    </span>
                  </a>
                </div>
